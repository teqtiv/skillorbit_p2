...
export class PasswordResetComponent implements OnInit,   OnDestroy {
        ...
        constructor(private _passChangeService:PassChangeService, private _authServices: AuthService,private _uiServices : UIService,private _router: Router, private _statusService:StatusService) {} 
        ...
        changepass(){
            ...
            this.Loadingbox='none';
            this._passChangeService.verifyandchange(this.key.trim().toString(),this.pass).subscribe((res)=>{
