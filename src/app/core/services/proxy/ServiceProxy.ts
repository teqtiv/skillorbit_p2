...
export class ServiceProxy {
    ...
    public DoPostGeneralCallQueryParams(
        method: string,
        data,
        queryParams,
        errorHandler,
            ...
            if (oReq.status == 200) {
                if (oReq.response) {
                    ...
                    if (arrayBuffer) {
                        ...
                        var byteArray = this.GetBinaryFromString(
                            oReq.responseText
                        );
