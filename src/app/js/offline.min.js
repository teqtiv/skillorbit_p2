...
function checkinternet() {
    ...
    //             xhr: {
    //                 url: function () {
    //                     return "https://dev-aws.veemed.com?_=" + Math.floor(1e9 * Math.random())
    //                 },
    //                 timeout: 5e3
    //             },
    //             image: {
    ...
    $(function () {
        ...
        $cartoffline.hide();
        $cartdisconect.hide();
        document.getElementById("offlinebox").removeAttribute("hidden")

        var internetDownMsgShow = false;
        // Offline.on('down', function () {
      
        //     internetDownMsgShow = true;

        //     $online.fadeOut(function () {

        //         setTimeout(function () {
        //             if (internetDownMsgShow) {
        //                 $offline.fadeIn();
        //                 if (document.getElementById("material-icons-2")) {
        //                     document.getElementById("material-icons-2").style.color = 'red';
        ...
        //     internetDownMsgShow = false;

        //     $offline.fadeOut(function () {
        //         $online.fadeIn();

        //         if (document.getElementById("material-icons-2")) {
        //             document.getElementById("material-icons-2").style.color = '#00AECC';

        //         }
        //         // document.getElementById("connecting-line-1").style.color='#00AECC';
